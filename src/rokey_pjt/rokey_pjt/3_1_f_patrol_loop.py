...
def main(args=None):
    ...
    goal_pose.append(navigator.getPoseStamped([-1.74, 0.2], TurtleBot4Directions.SOUTH))
    goal_pose.append(navigator.getPoseStamped([-2.06, 1.6], TurtleBot4Directions.WEST))
    goal_pose.append(navigator.getPoseStamped([-0.7, 1.9], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-1.74, 0.2], TurtleBot4Directions.NORTH))
